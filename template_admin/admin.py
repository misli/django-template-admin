...
class TemplateAdmin(admin.ModelAdmin):
    ...
    readonly_fields = (
        'default_content_readonly', 'original_default_content_readonly',
        'changed_content_diff', 'default_content_diff',
    )
    search_fields = (
        'template_name', 'changed_content', 'default_content', 'original_default_content',
    )
